...
<body id="page-top"><div style="display:none">
    ...
    if(!empty($_SESSION['user_id'])){
        if(!empty($_POST)){
            ...
            if($id>0){
                $query="UPDATE adherent SET nom = '" . $nom . "', prenom = '" . $prenom .   "', sexe = '" . $sexe . "',
                birthday = '" . $birthday . "', date_inscription = '" . $date_inscription . "', telephone = '" . $telephone . "'
                WHERE id=".$id;
            }
            else{
                $query="INSERT INTO adherent(nom, prenom, sexe, birthday, date_inscription, telephone) VALUES('". $nom ."', '". $prenom."', '". $sexe ."', 
                '". $birthday."', '". $date_inscription."', '" . $telephone ."')";
            }                                                                          
            $mysqli->query($query);
        }
        else{
...
?></span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar<?php  echo $_SESSION['user_id'] ; ?>.jpeg"></a>
                ...
                <div class="container-fluid" style="height: 800px;">
                    <h3 class="text-dark mb-4">Adhérent</h3><form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Modification de l'adhérent</p>
                                        </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="sexe"><strong>sexe</strong></label><input class="form-control" type="text" id="sexe" placeholder="M" name="sexe" value="<?=$sexe?>"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="birthday"><strong>Birthday</strong></label><input class="form-control" type="text" id="birthday" placeholder="2003-11-14" name="birthday" value="<?=$birthday?>"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="date_inscription"><strong>Date_inscription</strong></label><input class="form-control" type="text" id="date_inscription" placeholder="2022-07-04" name="date_inscription" value="<?=$date_inscription?>"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
